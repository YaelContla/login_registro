...
$pregunta10 = $_POST['answer10'];
$pregunta11 = $_POST['answer11'];
$pregunta12 = $_POST['answer12'];
...
if ( ($pregunta10 == 'd10') && ($pregunta11 == 'a11') && ($pregunta12 == 'c12') ) {

    $puntos1 = $puntos1 + 3;

    $mensaje1 ='Obtuviste '. $puntos1 . ' puntos y una calificacion de ' . $calf3;

} else if ( ($pregunta10 == 'd10') && ($pregunta11 == 'aS11') ) {

    $puntos1 = $puntos1 + 2;

    $mensaje1 ='Obtuviste '. $puntos1 . ' puntos y una calificacion de ' . $calf2;
    
} else if ( ($pregunta10 == 'd10') && ($pregunta12 == 'c12') ) {

    $puntos1 = $puntos1 + 2;

    $mensaje1 ='Obtuviste '. $puntos1 . ' puntos y una calificacion de ' . $calf2;

} else if ( ($pregunta11 == 'a11') && ($pregunta12 == 'c12') ) {

    $puntos1 = $puntos1 + 2;

    $mensaje1 ='Obtuviste '. $puntos1 . ' puntos y una calificacion de ' . $calf2;

}  else if ( ($pregunta10 == 'd10') || ($pregunta11 == 'a11') || ($pregunta12 == 'c12') ) {
